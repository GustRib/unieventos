  ...
  return (
    <div className="mx-auto max-w-md">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <h1 className="text-2xl font-bold text-slate-900">Registo de Expectador</h1>
        <p className="mt-1 text-sm text-slate-600">Crie a sua conta para participar em eventos.</p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <Input label="Curso" value={form.course} onChange={(e) => setForm({ ...form, course: e.target.value })} error={fieldErrors.course} required />
